!
    function(e, n, t) {
        ...
        function d() {
            var e = n.body;
            return e || (e = f(w ? "svg": "body"), e.fake = !0),
                e
        }
        function c(e, t, r, o) {
        ...
        function m(n, r) {
            ...
            if ("CSSSupportsRule" in e) {
                ...
                return s = s.join(" or "),
                    c("@supports (" + s + ") { #modernizr { position: absolute; } }",
                        function(e) {
        ...
        function v(e, n, o, s) {
            ...
            for (var p, d, c, v, h, y = ["modernizr", "tspan"]; ! P.style;) p = !0,
                P.modElem = f(y.shift()),
                P.style = P.modElem.style;
            for (c = e.length, d = 0; c > d; d++) if (v = e[d], h = P.style[v], a(v, "-") && (v = i(v)), P.style[v] !== t) {
                if (s || r(o, "undefined")) return l(),
                    "pfx" == n ? v: !0;
                try {
                    P.style[v] = o
                } catch(g) {}
                if (P.style[v] != h) return l(),
                    "pfx" == n ? v: !0
            }
            return l(),
                !1
